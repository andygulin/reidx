            ...
            <form class="form-inline">
                <div class="form-group">
                    <p class="input-group input-group-sm">
                        <input type="text" name="reidxId" class="form-control" value="${param.reidxId }"
                               placeholder="reidxId"/>
                    </p>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <p class="input-group input-group-sm">
                        <input type="text" name="rdStart" class="form-control"
                               onclick="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm:ss'});" value="${param.rdStart }"
                               placeholder="开始日期"/>
                    </p>~
                    <p class="input-group input-group-sm">
                        <input type="text" name="rdEnd" class="form-control"
                               onclick="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm:ss'});" value="${param.rdEnd }"
                               placeholder="结束日期"/>
                    </p>
                </div>
